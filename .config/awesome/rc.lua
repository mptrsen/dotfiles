...
beautiful.init("/home/malty/.config/awesome/themes/default/theme.lua")
...
-- {{{ Tags
-- Define a tag table which holds all screen tags and their settings.
tags = {
	settings = {
...
-- {{{ Wibox
-- Create a status bar to create room for conky
-- maybe
...
awful.rules.rules = {
    ...
    { rule = { class = "Thunderbird" },
		...
		-- Start rhythmbox on tag 9 of screen 1.
